...
def draw_room_background(ax):
    ...
    pipe_positions = [
        # 좌측 4개점
        (0.09, room_width - 0.16),
        (0.09, 0.16),
        (0.09, room_width - 0.29),
        (0.09, 0.29),

        (0.41, room_width - 0.16),
        (0.41, 0.16),
        (0.41, room_width - 0.29),
        (0.41, 0.29),

        (room_len - 6.2, room_width - 0.15),
        (room_len - 6.2, 0.15),

        (room_len - 2.1, room_width - 0.24),
        (room_len - 2.1, 0.24),

        (room_len - 0.24, room_width - 0.19),
        (room_len - 0.24, 0.19),
    ]
